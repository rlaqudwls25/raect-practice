    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<App />}>
          <Route index path="ex-router" element={<RouterIndex></RouterIndex>}></Route>
          ...
          <Route path="ex4" element={<Ex4ClassLifecycleMount></Ex4ClassLifecycleMount>}></Route>
          <Route path="ex5" element={<Ex5ClassLifecycleUpdate></Ex5ClassLifecycleUpdate>}></Route>
          ...
          <Route path="ex9" element={<Ex9UseEffectFetch></Ex9UseEffectFetch>}></Route>
        </Route>
      </Routes>
    </BrowserRouter>
  </React.StrictMode>
